...
namespace Aircompany.Planes
{
    public abstract class Plane
    {
        ...
        public static bool IsOrder(List<Plane> planes)
        {
            ...
            var expectedPlanesSortedByMaxLoadCapacity = planes.OrderBy(x => x.GetMaxLoadCapacity());
            return actualPlanesSortedByMaxLoadCapacity.SequenceEqual(expectedPlanesSortedByMaxLoadCapacity);
        }
